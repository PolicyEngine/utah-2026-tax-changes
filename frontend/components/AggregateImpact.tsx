...
export default function AggregateImpact({ triggered }: Props) {
    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Utah impact data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-primary">Utah impact analysis</h2>
      <p className="text-sm text-gray-600">
        Comparing current law ({UTAH_DASHBOARD_YEAR}) to pre-{UTAH_DASHBOARD_YEAR} law
      </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`rounded-lg p-5 border ${
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Change in Utah state tax collections
                </p>
              </div>
              <div className={`rounded-lg p-5 border ${
